...
const Leaderboard = () => {
  ...
  const [teams, setTeams] = useState([
    ...
    { id: 2, teamName: "SASAN WINGS", leader: "Saurabh Kushwaha", points: 0, college: "", members: ["", "", "", ""] },
    { id: 3, teamName: "VyomVeg", leader: "Puneet Singh", points: 0, college: "", members: ["", "", "", ""] },
    { id: 4, teamName: "Team AirRex", leader: "Priyanshu Mishra", points: 0, college: "", members: ["", "", "", ""] },
    ...
    { id: 12, teamName: "PropelX Duo", leader: "Akshata Shrivastava", points: 0, college: "", members: ["", "", "", ""] },
    { id: 13, teamName: "Airnova", leader: "Disha Yadav", points: 0, college: "", members: ["", "", "", ""] },
    { id: 14, teamName: "THE VALIENTS", leader: "Arpita Mishra", points: 0, college: "", members: ["", "", "", ""] },
    { id: 15, teamName: "Mach-Torrent", leader: "Nehal kumar singh", points: 0, college: "", members: ["", "", "", ""] },
    { id: 16, teamName: "GarudSena", leader: "Satyam Kumar", points: 0, college: "", members: ["", "", "", ""] },
    { id: 17, teamName: "AeroNova", leader: "Khushi Singh", points: 0, college: "", members: ["", "", "", ""] },
    { id: 18, teamName: "Air Predators", leader: "Kartik Pandey", points: 0, college: "", members: ["", "", "", ""] },
    { id: 19, teamName: "AeroVASS", leader: "Shwet pandey", points: 0, college: "", members: ["", "", "", ""] },
    { id: 20, teamName: "Sky Hawks", leader: "Vaishnavi Pandey", points: 0, college: "", members: ["", "", "", ""] },
    { id: 21, teamName: "Falcon Flyers", leader: "Mitali Raj", points: 0, college: "", members: ["", "", "", ""] },
    { id: 22, teamName: "VimanaX", leader: "Ratna Mishra", points: 0, college: "", members: ["", "", "", ""] },
    { id: 23, teamName: "Oracle  Wings", leader: "Aryan Yadav", points: 0, college: "", members: ["", "", "", ""] },
    { id: 24, teamName: "STORM CHASERS", leader: "Tanishk Pandey", points: 0, college: "", members: ["", "", "", ""] },
    { id: 25, teamName: "HAWKS", leader: "Tarun Kumar", points: 0, college: "", members: ["", "", "", ""] },
    { id: 26, teamName: "AERO ACES", leader: "Prakhar Pal", points: 0, college: "", members: ["", "", "", ""] },
    { id: 27, teamName: "WingMaster ", leader: "Om Prakash", points: 0, college: "", members: ["", "", "", ""] },
    { id: 28, teamName: "AEROEAGLES", leader: "PRINCE KUMAR GAUTAM", points: 0, college: "", members: ["", "", "", ""] },
    { id: 29, teamName: "Sky pirates", leader: "Vikash kumar prajapati", points: 0, college: "", members: ["", "", "", ""] },
    { id: 30, teamName: "AeroSynth", leader: "Jahnvi Singh", points: 0, college: "", members: ["", "", "", ""] },
    { id: 31, teamName: "ACE", leader: "Vivek Ashwani", points: 0, college: "", members: ["", "", "", ""] },
    { id: 32, teamName: "Team AARKK", leader: "Adarsh Yadav", points: 0, college: "", members: ["", "", "", ""] },
    { id: 33, teamName: "RISING ROTOR", leader: "Vedant Singh", points: 0, college: "", members: ["", "", "", ""] },
    { id: 34, teamName: "The Predator", leader: "Animesh Yadav", points: 0, college: "", members: ["", "", "", ""] },
    { id: 35, teamName: "AeroPulse ", leader: "Pranjal Chandra", points: 0, college: "", members: ["", "", "", ""] },
    { id: 36, teamName: "Falcon5", leader: "Abhishek Dubey", points: 0, college: "", members: ["", "", "", ""] },
    { id: 37, teamName: "FREEWINGS", leader: "Anmol Srivastava", points: 0, college: "", members: ["", "", "", ""] },
    { id: 38, teamName: "Tech Titans", leader: "keshav Agraval", points: 0, college: "", members: ["", "", "", ""] },
    { id: 39, teamName: "RR", leader: "AKSHAT YADAV", points: 0, college: "", members: ["", "", "", ""] },
    { id: 40, teamName: "FURIOUS SQUADRON", leader: "ANANYA PANDEY", points: 0, college: "", members: ["", "", "", ""] },
    { id: 41, teamName: "Aktisukh", leader: "Harsh Singh", points: 0, college: "", members: ["", "", "", ""] },
    { id: 42, teamName: "Tech vultures", leader: "Anshika Sharma", points: 0, college: "", members: ["", "", "", ""] },
    { id: 43, teamName: "AeroPulse", leader: "ADITYA KUMAR SINGH", points: 0, college: "", members: ["", "", "", ""] },
    { id: 44, teamName: "FalconX", leader: "Mahak keshari", points: 0, college: "", members: ["", "", "", ""] },
    { id: 45, teamName: "Megatron", leader: "Adarsh Singh", points: 0, college: "", members: ["", "", "", ""] },
    { id: 46, teamName: "Future flyers", leader: "Abhinay singh", points: 0, college: "", members: ["", "", "", ""] },
    { id: 47, teamName: "Swiftions", leader: "Abhinav Yadav", points: 0, college: "", members: ["", "", "", ""] },
    { id: 48, teamName: "Badmos Parinda ", leader: "Sparsh Srivastava", points: 0, college: "", members: ["", "", "", ""] },
    { id: 49, teamName: "SkyServos", leader: "Isha Chaurasiya", points: 0, college: "DDU", members: ["", "", "", ""] }
  ]);
